...
SUPPORTED_MODELS=("openvla" "openvla-oft" "openpi" "act" "gr00t" "gr00t_n1d6" "gr00t_n1d7" "dexbotic" "starvla" "lingbotvla" "dreamzero" "qwen3_vl" "abot_m0")
...
install_act_model() {
    case "$ENV_NAME" in
        robotwin)
            ...
            ;;
        *)
            echo "Environment '$ENV_NAME' is not supported for ACT model." >&2
            exit 1
            ;;
    esac
}
